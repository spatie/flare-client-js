<script lang="ts">
    ...
    import HeaderBuggyButton from '$lib/HeaderBuggyButton.svelte';
    import NestedParent from '$lib/NestedParent.svelte';
    import SidebarBuggyButton from '$lib/SidebarBuggyButton.svelte';
...
<!-- Component tree disambiguation (multi-instance) -->
<TestSection
