...
const ProductsPage = () => {
    // Fired from an effect, not a route loader: this playground's e2e suite pins one loader route and
    // one loader-less route, and adding loaders here would change those shapes.
